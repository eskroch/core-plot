 ...
 **/
@implementation CPTPolarAxisSet

/** @property CPTPolarAxis *majorAxis
 *  @brief The x-axis(major axis).
 **/
@dynamic majorAxis;

/** @property CPTPolarAxis *minorAxis
 *  @brief The y-axis(minor axis).
 **/
@dynamic minorAxis;

/** @property CPTPolarAxis *zAxis
...
/** @brief Initializes a newly allocated CPTPolarAxisSet object with the provided frame rectangle.
 *
 ...
 *  <tr><td>@ref zAxis</td><td>#CPTCoordinateZ</td><td>#CPTSignNone</td></tr>
 *  </table>
 *
 *  @param newFrame The frame rectangle.
 *  @return The initialized CPTPolarAxisSet object.
 **/
-(nonnull instancetype)initWithFrame:(CGRect)newFrame
{
    if ((self = [super initWithFrame:newFrame])) {
        ...
        CPTPolarAxis *minorAxis = [(CPTPolarAxis *)[CPTPolarAxis alloc] initWithFrame:newFrame];
        minorAxis.coordinate    = CPTCoordinateY;
        minorAxis.tickDirection = CPTSignNegative;
...
-(nullable CPTPolarAxis *)majorAxis
{
    return (CPTPolarAxis *)[self axisForCoordinate:CPTCoordinateX atIndex:0];
}

-(nullable CPTPolarAxis *)minorAxis
{
    return (CPTPolarAxis *)[self axisForCoordinate:CPTCoordinateY atIndex:0];
}

-(nullable CPTPolarAxis *)radialAxis
{
    return (CPTPolarAxis *)[self axisForCoordinate:CPTCoordinateZ atIndex:0];
}
